...
$pageParent  = 'tax_ruleRead.php';
if ($isMobile) {
  $pageCreate = 'tax_ruleFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'tax_ruleForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="tax_ruleRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
