...
$pageParent  = 'tax_classRead.php';
if ($isMobile) {
  $pageCreate = 'tax_classFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'tax_classForm.php';           // read id Desktop
}

$urlParent   = $urlWebClient . $pathWebClient.            // https://www.telepieza.com/recambios/frontend/
$pageAction  = $urlParent . $pageCreate . $actionReadId ; // https://www.telepieza.com/recambios/frontend/tax_classForm.php?action=Read&id=
$pageCreate .= $actionCreate;                             // tax_classForm.php?action=create
$urlParent  .= $pageParent ;                              // https://www.telepieza.com/recambios/frontend/tax_classRead.php
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      <div class="col-md-12">
        <div class="row">
           <div class="d-lg-flex align-items-center mb-2">
               ...
               <h1 class="text-white"><?php echo $company ; ?> TEST API tax_class</h1>
            </div>
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="tax_classRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
