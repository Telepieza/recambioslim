<?php
/**
  * tax_classFormMovil.php
  * Description: Mobile tax_class form
  * @Author : M.V.M.
  * @Version 1.0.8
  * --------------- Fields -----------------
  * getfieldid()  (int)    tax_class_id
  * getfield01()  (string) title
  * getfield02()  (string) description
  * getfield03()  (string) date_added
  * getfield04()  (string) date_modifiedd
**/

 if (!defined('_TEXEC'))  define( '_TEXEC' , 1) ;
 
 (string) $endpoint   = 'api/tax_class';  // endpoint tax_class
 ...
 include_once $ruteEntity.'tax_class.php';        // template tax_class
 ...
 ?>
  <body>
    <div class="container">
       <h1 class="flex-item text-white"><?php echo  $company ; ?> TEST API tax_class</h1>
       <hr>
        <div class="row m-auto">
          <main class="container-fluid">
            <div class="p-1 col-md-6 order-2 order-lg-1 bg-dark">
                <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="tax_classFormMovil.php?action=Read" onsubmit="return verifForm([id],'Error : fields marked with an asterisk are mandatory!');">
                ...
                <form method="post" action="tax_classFormMovil.php?action=<?php echo $action."&amp;id={$id}"; ?>"
                      ...
                      <div class="form-floating mb-1">
                         ...
                         <button type="button" class="col-lg-2 btn btn-success btn-info pe-2 ><a href="tax_classFormMovil.php?action=Cancel">Cancel</a></button>
                         <?php  if ('' != $id && $status == 200) { 
                           echo "<button type=\"button\" class=\"col-lg-2 btn btn-success text-danger btn-warning pe-24 \">
                           <a onclick=\"return confirm('Delete customer #{$id}');\" href=\"tax_classFormMovil.php?action=Delete&amp;id={$id}\">Delete</a>
                           </button>"; }
