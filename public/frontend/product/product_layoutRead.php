...
$pageParent  = 'product_layoutRead.php';
if ($isMobile) {
  $pageCreate = 'product_layoutFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'product_layoutForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="product_layoutRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
