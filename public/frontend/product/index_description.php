...
/**
  * index.php
  * Description: product_description table index
  * @Author : M.V.M.
  * @Version 1.0.11
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - product_description</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/product_description/">Category table documentation /api/product_description/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="product_descriptionRead.php">Desk product_description GET ALL /api/product_description</a></td>
                    <td>Desktop product_description of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="product_descriptionForm.php?action=index">Desk product_description GET and POST /api/product_description</a></td>
                    <td>Desktop test form product_description table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="product_descriptionFormMovil.php?action=index">Mobile product_description GET and POST /api/product_description</a></td>
                   <td>Mobile test form product_description table by ID</td>
                  </tr>
                  <tr class="table-info">
