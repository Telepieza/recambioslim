...
/**
  * index_related.php
  * Description: product_related table index
  * @Author : M.V.M.
  * @Version 1.0.11
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - product_related</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/product_related/">Category table documentation /api/product_related/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="product_relatedRead.php">Desk product_related GET ALL /api/product_related</a></td>
                    <td>Desktop product_related of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="product_relatedForm.php?action=index">Desk product_related GET and POST /api/product_related</a></td>
                    <td>Desktop test form product_related table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="product_relatedFormMovil.php?action=index">Mobile product_related GET and POST /api/product_related</a></td>
                   <td>Mobile test form product_related table by ID</td>
                  </tr>
                  <tr class="table-info">
