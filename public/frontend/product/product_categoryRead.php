...
$pageParent  = 'product_categoryRead.php';
if ($isMobile) {
  $pageCreate = 'product_categoryFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'product_categoryForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="product_categoryRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
