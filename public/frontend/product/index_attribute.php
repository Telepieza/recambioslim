...
/**
  * index.php
  * Description: product_attribute table index
  * @Author : M.V.M.
  * @Version 1.0.11
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - product_attribute</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/product_attribute/">Category table documentation /api/product_attribute/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="product_attributeRead.php">Desk product_attribute GET ALL /api/product_attribute</a></td>
                    <td>Desktop product_attribute of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="product_attributeForm.php?action=index">Desk product_attribute GET and POST /api/product_attribute</a></td>
                    <td>Desktop test form product_attribute table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="product_attributeFormMovil.php?action=index">Mobile product_attribute GET and POST /api/product_attribute</a></td>
                   <td>Mobile test form product_attribute table by ID</td>
                  </tr>
                  <tr class="table-info">
