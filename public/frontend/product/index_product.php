              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/product/">Product table documentation /api/product/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="productRead.php">Desk product GET ALL /api/product</a></td>
                    <td>Desktop product of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="productForm.php?action=index">Desk product GET and POST /api/product</a></td>
                    <td>Desktop test form product table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="productFormMovil.php?action=index">Mobile product GET and POST /api/product</a></td>
                   <td>Mobile test form product table by ID</td>
                  </tr>
                  <tr class="table-info">
