<?php
/**
  * product_storeForm.php
  * Description: Desktop product_store form
  * @Author : M.V.M.
  * @Version 1.0.11
  * --------------- Fields -----------------
       ...
       <div class="container shadow-lg mx-5 p-4">
         <div class="col-md-8">
           <div class="row">
             <div class="d-lg-flex align-items-center mb-2">
               ...
               <h1 class="text-white"><?php echo $company ; ?> TEST API product_store</h1>
             </div>
        ...
        <div class="row">
          ...
          <main class="container-fluid">
            ...
            <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="product_storeForm.php?action=Read" onsubmit="return verifForm([id],'Error : fields marked with an asterisk are mandatory!');">
            ...
            <form class="form-horizontal mb-2" method="post" action="product_storeForm.php?action=<?php echo $action."&amp;id={$id}"; ?>"
              ...
              <div class="form-group row mb-0 pe-4">
                ...
                <div class="col-sm-2">
                  <button type="button" class="col-lg-8 btn btn-success btn-info pe-4" ><a href="product_storeForm.php?action=Cancel">Cancel</a></button>
                </div>
              
                <?php  if ('' != $id && $status == 200) {
                  echo "<div class=\"col-sm-2\">
                      <button type=\"button\" class=\"col-lg-8 btn btn-success text-danger btn-warning pe-4 \">
                      <a onclick=\"return confirm('Delete customer #{$id}');\" href=\"product_storeForm.php?action=Delete&amp;id={$id}\">Delete</a>
                      </button></div>"; }
