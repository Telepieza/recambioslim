...
/**
  * index_layout.php
  * Description: product_layout table index
  * @Author : M.V.M.
  * @Version 1.0.11
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - product_layout</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/product_layout/">Category table documentation /api/product_layout/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="product_layoutRead.php">Desk product_layout GET ALL /api/product_layout</a></td>
                    <td>Desktop product_layout of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="product_layoutForm.php?action=index">Desk product_layout GET and POST /api/product_layout</a></td>
                    <td>Desktop test form product_layout table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="product_layoutFormMovil.php?action=index">Mobile product_layout GET and POST /api/product_layout</a></td>
                   <td>Mobile test form product_layout table by ID</td>
                  </tr>
                  <tr class="table-info">
