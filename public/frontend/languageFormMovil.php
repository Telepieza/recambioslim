            ...
            <div class="p-1 col-12 col-lg-6 order-2 order-lg-1 bg-dark">
                ...
                <form method="post" action="languageFormMovil.php?action=<?php echo $action."&amp;id={$id}"; ?>"
                        ...
                        <div class="form-floating mb-1 w-25">
                          ...
                          <input type="number"  class="form-control" readonly disabled name="language_id" placeholder="language_id" value="<?php { echo $id ; } ?>"/> 
                        </div>
                      ...
                      <div class="form-floating mb-1">
                         ...
                         <button type="button" class="col-lg-2 btn btn-success btn-info pe-4" ><a href="languageFormMovil.php?action=Cancel">Cancel</a></button>
