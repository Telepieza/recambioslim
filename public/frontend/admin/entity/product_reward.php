...
function setFormFields() {
    ...
    $id      = $_REQUEST[getfieldid()];  // product_reward_id
    $value01 = $_REQUEST[getfield01()];  // product_id
    $value02 = $_REQUEST[getfield02()];  // customer_group_id
    $value03 = $_REQUEST[getfield03()];  // points
