...
/**
  * index_activity.php
  * Description: customer_activity table index
  * @Author : M.V.M.
  * @Version 1.0.9
**/
            ...
            <div class="table-responsive">
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <td><a target="new" href="customer_activityRead.php">Desk customer_activity GET ALL /api/customer_activity</a></td>
                    <td>Desktop category of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="customer_activityForm.php?action=index">Desk customer_activity GET and POST /api/customer_activity</a></td>
                    <td>Desktop test form category table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="customer_activityFormMovil.php?action=index">Mobile customer_activity GET and POST /api/customer_activity</a></td>
