<?php
/**
  * customerFormMovil.php
  * Description: Mobile customer form
  * @Author : M.V.M.
  * @Version 1.0.10
  * --------------- Fields -----------------
...
**/
 ...
 ?>
  <body>
    <div class="container">
       <h1 class="flex-item text-white"><?php echo  $company ; ?> TEST API customer</h1>
       <hr>
        <div class="row m-auto">
          <main class="container-fluid">
            <div class="p-1 col-md-6 order-2 order-lg-1 bg-dark">
                <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="customerFormMovil.php?action=Read" onsubmit="return verifForm([id],'Error : fields marked with an asterisk are mandatory!');">
                ...
                <form method="post" action="customerFormMovil.php?action=<?php echo $action."&amp;id={$id}"; ?>"
                      onsubmit="return verifForm([<?php echo getfield01()?>,<?php echo getfield02()?>,<?php echo getfield03()?>,<?php echo getfield04()?>,<?php echo getfield05()?>,<?php echo getfield06()?>,<?php echo getfield07()?>,<?php echo getfield09()?>],'Error : fields marked with an asterisk are mandatory!');">
                        ...
                        <div class="form-floating mb-1 w-50">
                           <input type="number" class="form-control" name="<?php echo getfield03()?>" id="<?php echo getfield03()?>" min="1" placeholder="<?php echo getfield03()?>" value="<?php if (isset($val[0][getfield03()])) {echo $val[0][getfield03()];}?>"/>
                       ...
                       <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield09()?>" id="<?php echo getfield09()?>" placeholder="<?php echo getfield09()?>" value="<?php if (isset($val[0][getfield09()])) {echo htmlspecialchars($val[0][getfield09()]);}?>"/>
                           <label for="<?php echo getfield09()?>">* <?php echo getfield09()?>:</label>
                       </div>

                       <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield10()?>" id="<?php echo getfield10()?>" placeholder="<?php echo getfield10()?>" value="<?php if (isset($val[0][getfield10()])) {echo htmlspecialchars($val[0][getfield10()]);}?>"/>
                       ...
                       <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield12()?>" id="<?php echo getfield12()?>" placeholder="<?php echo getfield12()?>" value="<?php if (isset($val[0][getfield12()])) {echo htmlspecialchars($val[0][getfield12()]);}?>"/>
                           <label for="<?php echo getfield12()?>"><?php echo getfield12()?>:</label>
                       </div>

                       <div class="form-floating mb-1 w-50">
                           <input type="number" class="form-control" name="<?php echo getfield13()?>" id="<?php echo getfield13()?>" min="0" placeholder="<?php echo getfield13()?>" value="<?php if (isset($val[0][getfield13()])) {echo $val[0][getfield13()];}?>"/>
                           <label for="<?php echo getfield13()?>"><?php echo getfield13()?>:</label>
                      </div>

                      <div class="form-floating mb-1 w-50">
                           <input type="number" class="form-control" name="<?php echo getfield14()?>" id="<?php echo getfield14()?>" min="0" placeholder="<?php echo getfield14()?>" value="<?php if (isset($val[0][getfield14()])) {echo $val[0][getfield14()];}?>"/>
                           <label for="<?php echo getfield14()?>"><?php echo getfield14()?>:</label>
                      </div>

                      <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield15()?>" id="<?php echo getfield15()?>" placeholder="<?php echo getfield15()?>" value="<?php if (isset($val[0][getfield15()])) {echo htmlspecialchars($val[0][getfield15()]);}?>"/>
                           <label for="<?php echo getfield15()?>"><?php echo getfield15()?>:</label>
                       </div>

                       <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield16()?>" id="<?php echo getfield16()?>" placeholder="<?php echo getfield16()?>" value="<?php if (isset($val[0][getfield16()])) {echo htmlspecialchars($val[0][getfield16()]);}?>"/>
                           <label for="<?php echo getfield16()?>"><?php echo getfield16()?>:</label>
                       </div>

                       <div class="form-floating mb-1 w-50">
                           <input type="number" class="form-control" name="<?php echo getfield17()?>" id="<?php echo getfield17()?>" min="0" placeholder="<?php echo getfield17()?>" value="<?php if (isset($val[0][getfield17()])) {echo $val[0][getfield17()];}?>"/>
                           <label for="<?php echo getfield17()?>"><?php echo getfield17()?>:</label>
                      </div>

                      <div class="form-floating mb-1 w-50">
                           <input type="number" class="form-control" name="<?php echo getfield18()?>" id="<?php echo getfield18()?>" min="0" placeholder="<?php echo getfield18()?>" value="<?php if (isset($val[0][getfield18()])) {echo $val[0][getfield18()];}?>"/>
                           <label for="<?php echo getfield18()?>"><?php echo getfield18()?>:</label>
                      </div>
                       
                      <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield19()?>" id="<?php echo getfield19()?>" placeholder="<?php echo getfield19()?>" value="<?php if (isset($val[0][getfield19()])) {echo htmlspecialchars($val[0][getfield19()]);}?>"/>
                           <label for="<?php echo getfield19()?>"><?php echo getfield19()?>:</label>
                      </div>

                      <div class="form-floating mb-1">
                           <input type="text" class="form-control" name="<?php echo getfield20()?>" id="<?php echo getfield20()?>" placeholder="<?php echo getfield20()?>" value="<?php if (isset($val[0][getfield20()])) {echo htmlspecialchars($val[0][getfield20()]);}?>"/>
                      ...
                      <div class="form-floating mb-1 w-75">
                         ...
                         <?php if ($action != "create") {
                           ...
                           id="<?php echo getfield21()?>" placeholder="<?php echo $date; ?>" size="20" value="<?php if (isset($val[0][getfield21()])) {echo htmlspecialchars($val[0][getfield21()]);}?>"/>
                      ...
                      <div class="form-floating mb-1">
                         ...
                         <button type="button" class="col-lg-2 btn btn-success btn-info pe-2 ><a href="customerFormMovil.php?action=Cancel>Cancel</a></button>
                         <?php  if ('' != $id && $status == 200) {
                           echo "<button type=\"button\" class=\"col-lg-2 btn btn-success text-danger btn-warning pe-24 \">
                           <a onclick=\"return confirm('Delete customer #{$id}');\" href=\"customerFormMovil.php?action=Delete&amp;id={$id}\">Delete</a>
                           </button>"; }
