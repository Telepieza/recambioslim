...
/**
  * index_ip.php
  * Description: customer_ip table index
  * @Author : M.V.M.
  * @Version 1.0.9
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - customer_ip</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/customer_ip/">Customer ip table documentation /api/customer_ip/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="customer_ipRead.php">Desk customer_ip GET ALL /api/customer_ip</a></td>
                    <td>Desktop category of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="customer_ipForm.php?action=index">Desk customer_ip GET and POST /api/customer_ip/<a></td>
                    <td>Desktop test form category table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="customer_ipFormMovil.php?action=index">Mobile customer_ip GET and POST /api/customer_ip</a></td>
