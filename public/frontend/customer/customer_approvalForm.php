       ...
       <div class="container shadow-lg mx-5 p-4">
        ...
        <div class="row">
          ...
          <main class="container-fluid">
            ...
            <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="customer_approvalForm.php?action=Read" onsubmit="return verifForm([id],'Error : fields marked with an asterisk are mandatory!');">
            ...
            <form class="form-horizontal mb-2" method="post" action="customer_approvalForm.php?action=<?php echo $action."&amp;id={$id}"; ?>"
              ...
              <div class="form-group row mb-0 pe-4">
                ...
                <div class="col-sm-2">
                  <button type="button" class="col-lg-8 btn btn-success btn-info pe-4" ><a href="customer_approvalForm.php?action=Cancel">Cancel</a></button>
                </div>
              
                <?php  if ('' != $id && $status == 200) { 
                  echo "<div class=\"col-sm-2\">
                      <button type=\"button\" class=\"col-lg-8 btn btn-success text-danger btn-warning pe-4 \">
                      <a onclick=\"return confirm('Delete customer #{$id}');\" href=\"customer_approvalForm.php?action=Delete&amp;id={$id}\">Delete</a>
                      </button></div>"; }
