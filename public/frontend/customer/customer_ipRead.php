...
$pageParent  = 'customer_ipRead.php';
if ($isMobile) {
  $pageCreate = 'customer_ipFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'customer_ipForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="customer_ipRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
