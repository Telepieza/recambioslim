...
/**
  * index_approval.php
  * Description: customer_approval table index
  * @Author : M.V.M.
  * @Version 1.0.9
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - customer_approval</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/customer_approval/">Customer approval table documentation /api/customer_approval/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="customer_approvalRead.php">Desk customer_approval GET ALL /api/customer_approval</a></td>
                    <td>Desktop category of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="customer_approvalForm.php?action=index">Desk customer_approval GET and POST /api/customer_approval</a></td>
                    <td>Desktop test form category table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="customer_approvalFormMovil.php?action=index">Mobile customer_approval GET and POST /api/customer_approval</a></td>
