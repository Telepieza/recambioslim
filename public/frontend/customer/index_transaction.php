<?php
/**
  * index_transaction.php
  * Description: customer_transaction table index
  * @Author : M.V.M.
  * @Version 1.0.9
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - customer_transaction</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/customer_transaction/">Customer activity table documentation /api/customer_transaction/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="customer_transactionRead.php">Desk customer_transaction GET ALL /api/customer_transaction</a></td>
                    <td>Desktop category of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="customer_transactionForm.php?action=index">Desk customer_transaction GET and POST /api/customer_transaction</a></td>
                    <td>Desktop test form category table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="customer_transactionFormMovil.php?action=index">Mobile customer_transaction GET and POST /api/customer_transaction</a></td>
