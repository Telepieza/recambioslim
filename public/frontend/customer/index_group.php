...
/**
  * index_group.php
  * Description: customer_group table index
  * @Author : M.V.M.
  * @Version 1.0.9
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - customer_group</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/customer_group/">Customer group table documentation /api/customer_group/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="customer_groupRead.php">Desk customer_group GET ALL /api/customer_group</a></td>
                    <td>Desktop category of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="customer_groupForm.php?action=index">Desk customer_group GET and POST /api/customer_group</a></td>
                    <td>Desktop test form category table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="customer_groupFormMovil.php?action=index">Mobile customer_group GET and POST /api/customer_group</a></td>
