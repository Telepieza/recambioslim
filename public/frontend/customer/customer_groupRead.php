...
$pageParent  = 'customer_groupRead.php';
if ($isMobile) {
  $pageCreate = 'customer_groupFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'customer_groupForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="customer_groupRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
