...
/** 
  * index.php
  * Description: country table index
  * @Author : M.V.M.
  * @Version 1.0.5
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
        <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - Country</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tr class="table-warning">
                  ...
                  <tr class="table-light">
                    <td><a target="new" href="countryRead.php">Desk country GET ALL /api/country</a></td>
                    <td>Desktop test country of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                    <td><a target="new" href="countryForm.php?action=index">Desk country GET and POST /api/country</a></td>
                    <td>Desktop test form geo_zone table by ID</td>
                  </tr>
                  <tr class="table-light">
                    <td><a target="new" href="countryFormMovil.php?action=index">Mobile country GET and POST /api/country</a></td>
                    <td>Mobile test form country table by ID</td>
                  </tr>
                  <tr class="table-info">
