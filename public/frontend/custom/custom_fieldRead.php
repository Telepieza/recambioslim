...
$pageParent  = 'custom_fieldRead.php';
if ($isMobile) {
  $pageCreate = 'custom_fieldFormMovil.php';     // read id Mobile
 } else {
  $pageCreate = 'custom_fieldForm.php';           // read id Desktop
}
    ...
    <div class="section_item container shadow-lg mx-5 p-4">
      ...
      <div class="row">
        <div class="container-fluid">
          <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="custom_fieldRead.php?action=Pagination" onsubmit="return verifForm([offset,limit],'Error : fields marked with an asterisk are mandatory!');">
