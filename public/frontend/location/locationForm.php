...
/**
  * locationForm.php
  * Description: Desktop location form
  * @Author : M.V.M.
  * @Version 1.0.17
  * --------------- Fields -----------------
       ...
       <div class="container shadow-lg mx-5 p-4">
        ...
        <div class="row">
          ...
          <main class="container-fluid">
            ...
            <form class="mb-2" role = "form" aria-activedescendant="" method="post" action="locationForm.php?action=Read" onsubmit="return verifForm([id],'Error : fields marked with an asterisk are mandatory!');">
            ...
            <form class="form-horizontal mb-2" method="post" action="locationForm.php?action=<?php echo $action."&amp;id={$id}"; ?>"
              ...
              <div class="form-group row mb-1">
               <label for="<?php echo getfield03()?>" class="col-sm-2 d-flex justify-content-end align-items-center pe-3 ">* <?php echo getfield03()?>:</label>
                <div class="col-sm-2 col-lg-6">
                 <input type="text" class="form-control" name="<?php echo getfield03()?>" min="0" placeholder="<?php echo getfield03()?>" value="<?php if (isset($val[0][getfield03()])) {echo htmlspecialchars($val[0][getfield03()]);}?>"/>
               </div>
              </div>
              ...
              <div class="form-group row mb-1">
                ...
                <div class="col-sm-2 col-lg-6">
                  <input type="text" class="form-control" name="<?php echo getfield06()?>" min="0" placeholder="<?php echo getfield06()?>" value="<?php if (isset($val[0][getfield06()])) {echo htmlspecialchars($val[0][getfield06()]);}?>"/>
                </div>
              </div>
              ...
              <div class="form-group row mb-1">
                ...
                <div class="col-sm-2 col-lg-6">
                  <input type="text" class="form-control" name="<?php echo getfield08()?>" min="0" placeholder="<?php echo getfield08()?>" value="<?php if (isset($val[0][getfield08()])) {echo htmlspecialchars($val[0][getfield08()]);}?>"/>
                </div>
              </div>
              ...
              <div class="form-group row mb-0 pe-4">
                ...
                <div class="col-sm-2">
                  <button type="button" class="col-lg-8 btn btn-success btn-info pe-4" ><a href="locationForm.php?action=Cancel">Cancel</a></button>
                </div>
              
                <?php  if ('' != $id && $status == 200) { 
                  echo "<div class=\"col-sm-2\">
                      <button type=\"button\" class=\"col-lg-8 btn btn-success text-danger btn-warning pe-4 \">
                      <a onclick=\"return confirm('Delete customer #{$id}');\" href=\"locationForm.php?action=Delete&amp;id={$id}\">Delete</a>
                      </button></div>"; }
