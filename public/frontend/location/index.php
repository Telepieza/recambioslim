...
/** 
  * index.php
  * Description: location table index
  * @Author : M.V.M.
  * @Version 1.0.6
**/
  ...
  <main class="container-fluid">
    <div class="section_item container">
       <div class="d-lg-flex align-items-center mt-4">
          ...
          <h1 class="text-light"><?php echo $company ; ?> Recambios - Location</h1>
        </div>
        <hr>
        <div class="row">
              ...
              <table id="tableMain" class="table table-sm table-hover table-striped table-bordered table-condensed m-0">
                ...
                <tbody>
                  ...
                  <tr class="table-warning">
                    <td><a target="new" href="<?php echo $route;?>api/location/">Location table documentation /api/location/</a></td>
                    <td>Schemas, json structure, type of data and error code</td>
                  </tr>
                  <tr class="table-light">
                  <td><a target="new" href="locationRead.php">Desk location GET ALL /api/location</a></td>
                    <td>Desktop location of all rows table form.</td>
                  </tr>
                  <tr class="table-info">
                  <td><a target="new" href="locationForm.php?action=index">Desk location GET and POST /api/location</a></td>
                    <td>Desktop test form location table by ID</td>
                  </tr>
                  <tr class="table-light">
                   <td><a target="new" href="locationFormMovil.php?action=index">Mobile location GET and POST /api/location</a></td>
                   <td>Mobile test form location table by ID</td>
                  </tr>
                  <tr class="table-info">
