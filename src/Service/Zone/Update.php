...
namespace App\Service\Zone;                                               // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Zone;                                                      // (1) Modify in the new class the use, if the class is copied.
...
final class Update
{
  public function update(Request $request, array $args, BaseParameters $parameters)
  {
    ...
    $tableClass    = new Zone($parameters->getPrefix(),$body);               // (1) Modify in the new class the tableClass, if the class is copied
