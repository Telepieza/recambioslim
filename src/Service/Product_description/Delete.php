...
namespace App\Service\Product_description;                                    // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Product_description ;                                          // (1) Modify in the new class the use, if the class is copied.
...
final class Delete extends BaseUserAgent
{
  public function delete(Request $request, array $args, BaseParameters $parameters)
  {
     ...
     $tableClass    = new Product_description($parameters->getPrefix(),$body);                 // (1) Modify in the new class the tableClass, if the class is copied
