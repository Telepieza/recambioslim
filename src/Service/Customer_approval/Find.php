...
/**
  * Find.php
  * Description: Service Customer_approval
  * @Author : M.V.M.
  * @Version 1.0.18
**/
declare(strict_types=1);

namespace App\Service\Customer_approval;                                      // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Customer_approval ;                                            // (1) Modify in the new class the use, if the class is copied.
...
*/
 final class Find
 {
    public function getAll(Request $request,BaseParameters $parameters)
    {
      ...
      $tableClass    = new Customer_approval($parameters->getPrefix(),$body);                 // (1) Modify in the new class the tableClass, if the class is copied  
