...
namespace App\Service\Location;                                      // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Location ;                                            // (1) Modify in the new class the use, if the class is copied.
