...
final class Find extends BaseRepository
{
   ...
   public function __construct(PDO $db,array $body,string $prefix)   // Constructor, pasa a global el objeto base de datos y los datos ya decodificado del tocken
   {
        $this->db     = $db;  
        $this->body   = $body;
        $this->prefix = $prefix;  
