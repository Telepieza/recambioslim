...
final class Find extends BaseRepository
{
   ...
   public function getUser()
   {
      ...
      {
         $message = "Invalid login - parameters";                         // Si no hay ningun parametro en el sql, mensaje de error.
      }
      ...
      {
           $result  = $this->query($this->db, $this->tableClass, $params, (int) $limit, (int) $offset);
