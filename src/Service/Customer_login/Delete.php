...
namespace App\Service\Customer_login;                                    // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Customer_login ;                                          // (1) Modify in the new class the use, if the class is copied.
