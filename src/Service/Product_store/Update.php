...
/**
  * Update.php
  * Description: Service Product_store
  * @Author : M.V.M.
  * @Version 1.0.11
**/
declare(strict_types=1);

namespace App\Service\Product_store;                                               // (1) Modify in the new class the namespace, if the class is copied.
use App\Entity\Product_store;                                                      // (1) Modify in the new class the use, if the class is copied.
...
final class Update
{
  public function update(Request $request, array $args, BaseParameters $parameters)
  {
    ...
    $tableClass    = new Product_store($parameters->getPrefix(),$body);               // (1) Modify in the new class the tableClass, if the class is copied
