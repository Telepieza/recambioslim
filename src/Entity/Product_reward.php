...
final class Product_reward extends BaseValidate {

    private $prefix     = "oc_";
    private $tablename  = "product_reward";
    private $fieldid    = 'product_reward_id';
    private $field00    = 'NoPrimaryKey';
    private $field01    = 'product_id';
    private $field02    = 'customer_group_id';
    private $field03    = 'points';

    private bool   $isAutoIncrement = true;   // index id auto_increment
    private int    $id;                       // id
    private int    $value01;                  // field01 (product_id)
    private int    $value02;                  // field02 (customer_group_id)
    private int    $value03;                  // field03 (points)
