...
final class Tax_rule extends BaseValidate
{
    ...
    private $field04    = 'priority';
   
    private bool   $isAutoIncrement = true;   // index id auto_increment
    private int    $id;                       // id (tax_rule_id)
    private int    $value01;                  // field01 (tax_class_id)
    private int    $value02;                  // field02 (tax_rate_id)
    private string $value03;                  // field03 (based)
    private int    $value04;                  // field04 (priority)
