...
final class Geo_zone extends BaseValidate
{
    private $prefix     = "oc_";
    private $tablename  = "geo_zone";
    private $fieldid    = 'geo_zone_id';
    ...
    private ?DateTimeImmutable $value03;      // field07 (date_added)
    private ?DateTimeImmutable $value04;      // field08 (date_modified)
